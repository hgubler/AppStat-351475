...
$$
where $B =$ 33 is the number of bootstrapped datasets (of course a much higher number would be desirable here but due to limitations in computational power we keep it low here).
