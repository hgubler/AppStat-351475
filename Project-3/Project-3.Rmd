...
To see if a poisson regression would make sense to model the goals, we look at the mean and variance of all the home goals and away goals per match.
...
min_50_resid <- head(sorted_resid, n = 800)
binary_vec = rep(0, nrow(data))
binary_vec[min_50_resid] = 1
data_res$col_ind = binary_vec
# finished testing ----------------------------------
...
Once we have the model without observations from these teams, we compare its coefficients to the coefficients of our original model.
