...
In our analysis we will treat year, state as well as all the regional variables as factors, while the remaining variables will be treated as numerical. Furthermore we will add an additional factor `region` to the dataset dividing the states in the regions "Northeast", "South", "Midwest" and "West.
